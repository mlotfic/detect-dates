...
class DateEntity:
    ...
    def __post_init__(self):
        ...
        self.start_hijri: Optional[DateComponents] = None
        self.end_hijri: Optional[DateComponents] = None
        self.start_gregorian: Optional[DateComponents] = None
        self.end_gregorian: Optional[DateComponents] = None
    ...
    def _is_complete_date(self, date_comp: DateComponents) -> bool:
    ...
    def _get_pair_relationship(self, date1: DateComponents, date2: DateComponents) -> str:
    ...
    def _is_financial_year_pattern(self, date1: DateComponents, date2: DateComponents) -> bool:
    ...
    def _is_range_pattern(self, date1: DateComponents, date2: DateComponents) -> bool:
    ...
    def _dates_qualify_for_comparison(self, date1: DateComponents, date2: DateComponents) -> bool:
    ...
    def _format_date_component(self, date_comp: DateComponents, format_template: str) -> str:
        """Format a single DateComponent using the template."""
        # This assumes DateComponents has a strftime method similar to your example
    ...
    def _manual_format(self, date_comp: DateComponents, format_template: str) -> str:
        """Manual formatting when strftime is not available on DateComponents."""
...
entity = DateEntity.create_with_mapper(
    raw_start=DateComponents(day=15, month=3, year=2024, calendar='gregorian'),
    raw_start_alt=DateComponents(day=8, month=9, year=1445, calendar='hijri'),  # This will be validated/corrected
    mapper=mapper
)
...
entity1 = DateEntity.create_with_mapper(
    raw_start=DateComponents(day=1, month=1, year=2024, calendar='gregorian'),
    raw_start_alt=DateComponents(day=19, month=6, year=1445, calendar='hijri'),  # Will verify this matches
    mapper=mapper
)

# Case 2: Financial year detection  
entity2 = DateEntity.create_with_mapper(
    raw_start=DateComponents(month=1, year=1445, calendar='hijri'),
    raw_start_alt=DateComponents(month=12, year=1445, calendar='hijri'),
    mapper=mapper
)

# Case 3: Complex range validation
entity3 = DateEntity.create_with_mapper(
    raw_start=DateComponents(day=1, month=3, year=2024, calendar='gregorian'),
    raw_start_alt=DateComponents(day=20, month=8, year=1445, calendar='hijri'),
    raw_end=DateComponents(day=31, month=3, year=2024, calendar='gregorian'), 
    raw_end_alt=DateComponents(day=19, month=9, year=1445, calendar='hijri'),
    mapper=mapper
)
...
class DateEntity:
    ...
    def _is_complete_date(self, date_comp: ) -> bool:
        """Check if a DateComponent represents a complete date."""
        return (date_comp.day is not None and 
                date_comp.month is not None and 
                date_comp.year is not None)
