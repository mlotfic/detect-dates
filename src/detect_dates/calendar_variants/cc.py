...
class DateMapping:
    ...
    def get_dates_by_month_year(self, calendar: str, month: int, year: int) -> List[Dict[str, Any]]:
        """
        Get all dates for a specific month and year in the given calendar system.

        This method retrieves all available dates within a specified month and year,
        returning complete calendar conversion information for each date.
        ...
        -------
        List[Dict[str, Any]]
            List of dictionaries, each containing date information for all
            calendar systems and weekday information
        ...
        # Build list of date dictionaries
        dates = []
        ...
        # Sort by day in the requested calendar system
