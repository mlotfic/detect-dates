ambagious_examples = [
    ...
    # ===================================================================================
    # variable: date_patterns.yy.numeric, 
    ...
    # variable: rf"{date_patterns.indicator.day}{date_patterns.indicator.separator}{date_patterns.numeric.day"}, 
    # type: "numeric", name: "day_component", format: [DD], calendar: UNKNOWN
    "يوم 01",
    "يوم 02",

    # variable: rf"{date_patterns.indicator.month{date_patterns.indicator.separator{date_patterns.numeric.month", 
    # type: "numeric", name: "month_component", format: [MM], calendar: UNKNOWN
    "شهر 01",
    "شهر 02",

    # variable: date_patterns.mm.hijri",
    # type: "named", name : "month_component_hijri", format: [MM-ERA], calendar: HIJRI 
    "محرم",

    # variable: date_patterns.mm.gregorian,
    # type: "named", name : "month_component_gregorian", format: [MM-ERA], calendar: GREGORIAN 
    "January",
    "فبراير",
    ...
    # variable: rf"{date_patterns.indicator.year}{date_patterns.indicator.separator}{date_patterns.numeric.year}"
    # type: "numeric", name : "year_component", format: [YYYY], calendar: UNKNOWN 
    "سنة 2023",
    "عام 1445",
    
    # variable: rf"{date_patterns.indicator.century}{date_patterns.indicator.separator}{date_patterns.numeric.century}"
    # type: "numeric", name : "century_component", format: [CC], calendar: UNKNOWN
    "القرن 21",
    "القرن 20",

    # variable: date_patterns.era.hijri
    # type: "named", name : "era_component_hijri", format: [ERA], calendar: HIJRI
    "هجري",      # Hijri era
    "هجرية",     # Hijri era (feminine)

    # variable: date_patterns.era.gregorian
    ...
    # ===================================================================================
    # variable: date_patterns.natural_language.numeric
    # type: "numeric", name : "weekday_dd_mm_yy", format: [WD-DD-MM-YYYY], calendar: UNKNOWN
    "الجمعة 15/03/1445",   # Friday 15th Rabi al-Awwal 1445 AH
    "الأحد 01/04/1446",    # Sunday 1st Ramadan 1446 AH  
...
natural_language_examples_gregorian = [
    ...
    # variable: date_patterns.natural_language.gregorian.alternative_parenthetical
    # type: "combined", name : "single_alternative_cs_natural_language_gregorian_hijri_parenthetical", format: [WD-MM-YYYY-ERA]-([WD-MM-YYYY-ERA]), calendar: GREGORIAN-HIJRI
    "الجمعة 15 يناير 2023 م/(السبت 10 محرم 1445 هـ)", # Friday 15th January 2023 CE/(Saturday 10th Muharram 1445 AH)
    "الأحد 25 ديسمبر 2024 م - (الاثنين 12 جمادى الأولى 1446 هـ)", # Sunday 25th December 2024 CE - (Monday 12th Jumada al-Ula 1446 AH)
    "من الثلاثاء 04 يوليو 2023 م إلى (الأربعاء 20 ذو الحجة 1444 هـ)", # From Tuesday 4th July 2023 CE to (Wednesday 20th Dhul Hijjah 1444 AH)
    "Saturday 31 December 2022 AD - (Sunday 10 ربيع الأول 1444 هـ)", # Saturday 31st December 2022 CE - (Sunday 10th Rabi al-Awwal 1444 AH)
    "الخميس 14 فبراير 2025 م - (الجمعة 22 ربيع الآخر 1446 هـ)", # Thursday 14th February 2025 CE - (Friday 22nd Rabi al-Thani 1446 AH)
    "من الخميس 01 مارس 2024 م إلى (الجمعة 15 شعبان 1445 هـ)", # From Thursday 1st March 2024 CE to (Friday 15th Sha'ban 1445 AH)
    "الأربعاء 22 نوفمبر 2024 م - (الخميس 30 رمضان 1445 هـ)", # Wednesday 22nd November 2024 CE - (Thursday 30th Ramadan 1445 AH)
    "Sunday 08 أغسطس 2022 CE - (Monday 16 ذو القعدة 1443 هـ)", # Sunday 8th August 2022 CE - (Monday 16th Dhul Qi'dah 1443 AH)
    "من الاثنين 17 سبتمبر 2025 م إلى (الثلاثاء 25 صفر 1447 هـ)", # From Monday 17th September 2025 CE to (Tuesday 25th Safar 1447 AH)
    ...
    # variable: date_patterns.dual_natural_language.gregorian.mixed
    # type: "combined", name : "dual_cs_natural_language_gregorian", format: [WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA], calendar: GREGORIAN
    "from Friday 15 January 2023 CE to Saturday 10 February 2024 CE - Sunday 25 March 2025 CE - Monday 01 April 2026 CE", # From Friday 15th January 2023 CE to Saturday 10th February 2024 CE - Sunday 25th March 2025 CE - Monday 1st April 2026 CE
    "from Tuesday 20 March 2020 CE to Wednesday 15 April 2022 CE - Thursday 10 May 2023 CE - Friday 25 June 2024 CE", # From Tuesday 20th March 2020 CE to Wednesday 15th April 2022 CE - Thursday 10th May 2023 CE - Friday 25th June 2024 CE
    "الجمعة 15 يناير 2024 م - السبت 10 فبراير 2025 م - الأحد 25 مارس 2026 م - الاثنين 01 أبريل 2027 م", # Friday 15th January 2024 CE - Saturday 10th February 2025 CE - Sunday 25th March 2026 CE - Monday 1st April 2027 CE
    "الثلاثاء 22 مايو 2023 م - الأربعاء 08 يونيو 2024 م - الخميس 17 يوليو 2025 م - الجمعة 29 أغسطس 2026 م", # Tuesday 22nd May 2023 CE - Wednesday 8th June 2024 CE - Thursday 17th July 2025 CE - Friday 29th August 2026 CE
    "من الأحد 10 سبتمبر 2023 م إلى الاثنين 15 أكتوبر 2024 م - الثلاثاء 20 نوفمبر 2025 م - الأربعاء 25 ديسمبر 2026 م", # From Sunday 10th September 2023 CE to Monday 15th October 2024 CE - Tuesday 20th November 2025 CE - Wednesday 25th December 2026 CE

    # variable: date_patterns.dual_natural_language.gregorian.mixed_parenthetical
    # type: "combined", name : "dual_cs_natural_language_gregorian_parenthetical", format: [WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]-([WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]), calendar: GREGORIAN
    "from Friday 15 January 2023 CE to Saturday 10 February 2024 CE - (Sunday 25 March 2025 CE - Monday 01 April 2026 CE)", # From Friday 15th January 2023 CE to Saturday 10th February 2024 CE - (Sunday 25th March 2025 CE - Monday 1st April 2026 CE)
    "from Tuesday 20 March 2020 CE to Wednesday 15 April 2022 CE - (Thursday 10 May 2023 CE - Friday 25 June 2024 CE)", # From Tuesday 20th March 2020 CE to Wednesday 15th April 2022 CE - (Thursday 10th May 2023 CE - Friday 25th June 2024 CE)
    "الجمعة 15 يناير 2024 م - السبت 10 فبراير 2025 م - (الأحد 25 مارس 2026 م - الاثنين 01 أبريل 2027 م)", # Friday 15th January 2024 CE - Saturday 10th February 2025 CE - (Sunday 25th March 2026 CE - Monday 1st April 2027 CE)
    "الثلاثاء 22 مايو 2023 م - الأربعاء 08 يونيو 2024 م - (الخميس 17 يوليو 2025 م - الجمعة 29 أغسطس 2026 م)", # Tuesday 22nd May 2023 CE - Wednesday 8th June 2024 CE - (Thursday 17th July 2025 CE - Friday 29th August 2026 CE)
    ...
    # variable: date_patterns.dual_natural_language.gregorian.mixed_double_parenthetical
    # type: "combined", name : "dual_cs_natural_language_gregorian_double_parenthetical", format: ([WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA])-([WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]), calendar: GREGORIAN
    "from (Friday 15 January 2023 CE to Saturday 10 February 2024 CE) - (Sunday 25 March 2025 CE - Monday 01 April 2026 CE)", # From (Friday 15th January 2023 CE to Saturday 10th February 2024 CE) - (Sunday 25th March 2025 CE - Monday 1st April 2026 CE)
    "from (Tuesday 20 March 2020 CE to Wednesday 15 April 2022 CE) - (Thursday 10 May 2023 CE - Friday 25 June 2024 CE)", # From (Tuesday 20th March 2020 CE to Wednesday 15th April 2022 CE) - (Thursday 10th May 2023 CE - Friday 25th June 2024 CE)
    "(الجمعة 15 يناير 2024 م - السبت 10 فبراير 2025 م) - (الأحد 25 مارس 2026 م - الاثنين 01 أبريل 2027 م)", # (Friday 15th January 2024 CE - Saturday 10th February 2025 CE) - (Sunday 25th March 2026 CE - Monday 1st April 2027 CE)
    "(الثلاثاء 22 مايو 2023 م - الأربعاء 08 يونيو 2024 م) - (الخميس 17 يوليو 2025 م - الجمعة 29 أغسطس 2026 م)", # (Tuesday 22nd May 2023 CE - Wednesday 8th June 2024 CE) - (Thursday 17th July 2025 CE - Friday 29th August 2026 CE)
    ...
    # variable: date_patterns.dual_natural_language.gregorian.mixed_alternative
    # type: "combined", name : "dual_cs_natural_language_alternative_gregorian", format: [WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA], calendar: GREGORIAN-HIJRI
    "الجمعة 15 يناير 2023 م - السبت 10 فبراير 2024 م - الأحد 20 محرم 1445 هـ - الاثنين 25 صفر 1446 هـ", # Friday 15th January 2023 CE - Saturday 10th February 2024 CE - Sunday 20th Muharram 1445 AH - Monday 25th Safar 1446 AH
    "الثلاثاء 20 مارس 2020 م - الأربعاء 15 أبريل 2022 م - الخميس 27 رجب 1440 هـ - الجمعة 01 شعبان 1445 هـ", # Tuesday 20th March 2020 CE - Wednesday 15th April 2022 CE - Thursday 27th Rajab 1440 AH - Friday 1st Sha'ban 1445 AH
    "Saturday 25 December 2023 CE - Sunday 31 January 2024 CE - Monday 15 ذو الحجة 1444 هـ - Tuesday 20 محرم 1445 هـ", # Saturday 25th December 2023 CE - Sunday 31st January 2024 CE - Monday 15th Dhul Hijjah 1444 AH - Tuesday 20th Muharram 1445 AH
    "من الأحد 10 يوليو 2022 م إلى الاثنين 15 أغسطس 2023 م - الثلاثاء 25 ذو القعدة 1443 هـ - الأربعاء 30 ذو الحجة 1444 هـ", # From Sunday 10th July 2022 CE to Monday 15th August 2023 CE - Tuesday 25th Dhul Qi'dah 1443 AH - Wednesday 30th Dhul Hijjah 1444 AH

    # variable: date_patterns.dual_natural_language.gregorian.mixed_alternative_parenthetical
    # type: "combined", name : "dual_cs_natural_language_alternative_gregorian_parenthetical", format: [WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]-([WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]), calendar: GREGORIAN-HIJRI
    "الجمعة 15 يناير 2023 م - السبت 10 فبراير 2024 م - (الأحد 20 محرم 1445 هـ - الاثنين 25 صفر 1446 هـ)", # Friday 15th January 2023 CE - Saturday 10th February 2024 CE - (Sunday 20th Muharram 1445 AH - Monday 25th Safar 1446 AH)
    "الثلاثاء 20 مارس 2020 م - الأربعاء 15 أبريل 2022 م - (الخميس 27 رجب 1440 هـ - الجمعة 01 شعبان 1445 هـ)", # Tuesday 20th March 2020 CE - Wednesday 15th April 2022 CE - (Thursday 27th Rajab 1440 AH - Friday 1st Sha'ban 1445 AH)
    "Saturday 25 December 2023 CE - Sunday 31 January 2024 CE - (Monday 15 ذو الحجة 1444 هـ - Tuesday 20 محرم 1445 هـ)", # Saturday 25th December 2023 CE - Sunday 31st January 2024 CE - (Monday 15th Dhul Hijjah 1444 AH - Tuesday 20th Muharram 1445 AH)
    "من الأحد 10 يوليو 2022 م إلى الاثنين 15 أغسطس 2023 م - (الثلاثاء 25 ذو القعدة 1443 هـ - الأربعاء 30 ذو الحجة 1444 هـ)", # From Sunday 10th July 2022 CE to Monday 15th August 2023 CE - (Tuesday 25th Dhul Qi'dah 1443 AH - Wednesday 30th Dhul Hijjah 1444 AH)

    # variable: date_patterns.dual_natural_language.gregorian.mixed_alternative_double_parenthetical
    # type: "combined", name : "dual_cs_natural_language_alternative_gregorian_double_parenthetical", format: ([WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA])-([WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]), calendar: GREGORIAN-HIJRI
    "(الجمعة 15 يناير 2023 م - السبت 10 فبراير 2024 م) - (الأحد 20 محرم 1445 هـ - الاثنين 25 صفر 1446 هـ)", # (Friday 15th January 2023 CE - Saturday 10th February 2024 CE) - (Sunday 20th Muharram 1445 AH - Monday 25th Safar 1446 AH)
    "(الثلاثاء 20 مارس 2020 م - الأربعاء 15 أبريل 2022 م) - (الخميس 27 رجب 1440 هـ - الجمعة 01 شعبان 1445 هـ)", # (Tuesday 20th March 2020 CE - Wednesday 15th April 2022 CE) - (Thursday 27th Rajab 1440 AH - Friday 1st Sha'ban 1445 AH)
    "(Saturday 25 December 2023 CE - Sunday 31 January 2024 CE) - (Monday 15 ذو الحجة 1444 هـ - Tuesday 20 محرم 1445 هـ)", # (Saturday 25th December 2023 CE - Sunday 31st January 2024 CE) - (Monday 15th Dhul Hijjah 1444 AH - Tuesday 20th Muharram 1445 AH)
    "من (الأحد 10 يوليو 2022 م إلى الاثنين 15 أغسطس 2023 م) - (الثلاثاء 25 ذو القعدة 1443 هـ - الأربعاء 30 ذو الحجة 1444 هـ)", # From (Sunday 10th July 2022 CE to Monday 15th August 2023 CE) - (Tuesday 25th Dhul Qi'dah 1443 AH - Wednesday 30th Dhul Hijjah 1444 AH)

    # variable: date_patterns.dual_natural_language.gregorian.alternative
    # type: "combined", name : "dual_cs_natural_language_alternative_gregorian", format: [WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA], calendar: GREGORIAN-HIJRI
    "الجمعة 15 يناير 2023 م - الأحد 20 محرم 1445 هـ - السبت 10 فبراير 2024 م - الاثنين 25 صفر 1446 هـ", # Friday 15th January 2023 CE - Sunday 20th Muharram 1445 AH - Saturday 10th February 2024 CE - Monday 25th Safar 1446 AH
    "الثلاثاء 20 مارس 2020 م - الخميس 27 رجب 1440 هـ - الأربعاء 15 أبريل 2022 م - الجمعة 01 شعبان 1445 هـ", # Tuesday 20th March 2020 CE - Thursday 27th Rajab 1440 AH - Wednesday 15th April 2022 CE - Friday 1st Sha'ban 1445 AH
    "Saturday 25 December 2023 CE - Monday 15 ذو الحجة 1444 هـ - Sunday 31 January 2024 CE - Tuesday 20 محرم 1445 هـ", # Saturday 25th December 2023 CE - Monday 15th Dhul Hijjah 1444 AH - Sunday 31st January 2024 CE - Tuesday 20th Muharram 1445 AH
    "الأحد 10 يوليو 2022 م - الثلاثاء 25 ذو القعدة 1443 هـ - الاثنين 15 أغسطس 2023 م - الأربعاء 30 ذو الحجة 1444 هـ", # Sunday 10th July 2022 CE - Tuesday 25th Dhul Qi'dah 1443 AH - Monday 15th August 2023 CE - Wednesday 30th Dhul Hijjah 1444 AH

    # variable: date_patterns.dual_natural_language.gregorian.alternative_parenthetical
    # type: "combined", name : "dual_cs_natural_language_alternative_gregorian_parenthetical", format: [WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]-([WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]), calendar: GREGORIAN-HIJRI
    "الجمعة 15 يناير 2023 م - الأحد 20 محرم 1445 هـ - (السبت 10 فبراير 2024 م - الاثنين 25 صفر 1446 هـ)", # Friday 15th January 2023 CE - Sunday 20th Muharram 1445 AH - (Saturday 10th February 2024 CE - Monday 25th Safar 1446 AH)
    "الثلاثاء 20 مارس 2020 م - الخميس 27 رجب 1440 هـ - (الأربعاء 15 أبريل 2022 م - الجمعة 01 شعبان 1445 هـ)", # Tuesday 20th March 2020 CE - Thursday 27th Rajab 1440 AH - (Wednesday 15th April 2022 CE - Friday 1st Sha'ban 1445 AH)
    "Saturday 25 December 2023 CE - Monday 15 ذو الحجة 1444 هـ - (Sunday 31 January 2024 CE - Tuesday 20 محرم 1445 هـ)", # Saturday 25th December 2023 CE - Monday 15th Dhul Hijjah 1444 AH - (Sunday 31st January 2024 CE - Tuesday 20th Muharram 1445 AH)
    ...
    # variable: date_patterns.dual_natural_language.gregorian.alternative_double_parenthetical
    # type: "combined", name : "dual_cs_natural_language_alternative_gregorian_double_parenthetical", format: ([WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA])-([WD-MM-YYYY-ERA]-[WD-MM-YYYY-ERA]), calendar: GREGORIAN-HIJRI
    "(الجمعة 15 يناير 2023 م - الأحد 20 محرم 1445 هـ) - (السبت 10 فبراير 2024 م - الاثنين 25 صفر 1446 هـ)", # (Friday 15th January 2023 CE - Sunday 20th Muharram 1445 AH) - (Saturday 10th February 2024 CE - Monday 25th Safar 1446 AH)
    "(الثلاثاء 20 مارس 2020 م - الخميس 27 رجب 1440 هـ) - (الأربعاء 15 أبريل 2022 م - الجمعة 01 شعبان 1445 هـ)", # (Tuesday 20th March 2020 CE - Thursday 27th Rajab 1440 AH) - (Wednesday 15th April 2022 CE - Friday 1st Sha'ban 1445 AH)
    "(Saturday 25 December 2023 CE - Monday 15 ذو الحجة 1444 هـ) - (Sunday 31 January 2024 CE - Tuesday 20 محرم 1445 هـ)", # (Saturday 25th December 2023 CE - Monday 15th Dhul Hijjah 1444 AH) - (Sunday 31st January 2024 CE - Tuesday 20th Muharram 1445 AH)
