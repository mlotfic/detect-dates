...
# Jalali/Persian Era Keywords - Iranian solar calendar system
# SH = Solar Hijri, starting from the same epoch as Islamic calendar but using solar year
era_after_Jalali_ar = era_keywords_dict["ar"]["Jalali"]["after_hijrah"]["keywords"]
era_after_Jalali_ar_normalized = era_keywords_dict["ar"]["Jalali"]["after_hijrah"]["normalized"]

era_after_Jalali_en = era_keywords_dict["en"]["Jalali"]["after_hijrah"]["keywords"]
era_after_Jalali_en_normalized = 

era_before_Jalali_ar = era_keywords_dict["ar"]["Jalali"]["before_hijrah"]["keywords"]
era_before_Jalali_ar_normalized = era_keywords_dict["ar"]["Jalali"]["before_hijrah"]["normalized"]
era_before_Jalali_en = era_keywords_dict["en"]["Jalali"]["before_hijrah"]["keywords"]
era_before_Jalali_en_normalized = era_keywords_dict["en"]["Jalali"]["before_hijrah"]["normalized"]
# ===================================================================================
# DATE PATTERNS
# ===================================================================================
...
basic_date_pattern_dict = {
    ...
    "patterns": [
        ...
        {  # Pattern 9 - Jalali Month/Year with Era Marker
            "pattern": month_year_pattern.Jalali,
        ...
        {  # Pattern 12 - Complete Jalali Date with Era Marker
            "pattern": day_month_year_pattern.Jalali,
        ...
        {  # Pattern 15 - Natural Language Jalali Date
            "pattern": natural_month_year_pattern.Jalali,
